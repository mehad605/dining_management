...
var show_item_price_in_menu,
  meal_name = "Lunch",
  hall_name = "Bangabandhu Sheikh Mujibur Rahman Hall",
  text_in_add_to_cart_button;
...
function showMenuItems(item_name, show_item_price_in_menu) {
  ...
  newElement.className = "card my-3 shadow border-0 pt-2 pb-2";

  // Set styles for the new element
  newElement.style.width = "24rem";

  newElement.innerHTML = `
  <section class="products">
    <div class="box-container">
      <form action="" method="post" class="box menu-item">
        <button type="submit" class="fas fa-eye" name="quick_view"></button>
        <button type="submit" class="fas fa-shopping-cart" name="add_to_cart"></button>
        <img src="../images/home-img-3.png" alt="Food Image" class="card-img-top" />
        <div class="name">${item_name}</div>
        <div class="flex">
          <div class="price"><span>$</span>${show_item_price_in_menu}</div>
          <input
            type="number"
            name="qty"
            class="qty"
...
function lunchButtonClicked() {
  document
    .getElementById("lunch-button")
    .addEventListener("click", function () {
      let lunch_button = document.getElementById("lunch-button");

      lunch_button.style.color = "black";
      lunch_button.style.letterSpacing = ".2rem";
      lunch_button.style.backgroundColor = "#fed330";
      lunch_button.style.border = "1px solid black";
      let dinner_button = document.getElementById("dinner-button");

      dinner_button.style.color = "black";
      dinner_button.style.backgroundColor = "#fff";
      dinner_button.style.letterSpacing = ".2rem";
      dinner_button.style.border = "1px solid black";
...
function dinnerButtonClicked() {
  document
    .getElementById("dinner-button")
    .addEventListener("click", function () {
      let dinner_button = document.getElementById("dinner-button");
      dinner_button.style.color = "black";
      dinner_button.style.letterSpacing = ".2rem";
      dinner_button.style.backgroundColor = "#fed330";
      dinner_button.style.border = "1px solid black";

      let lunch_button = document.getElementById("lunch-button");
      lunch_button.style.color = "black";
      lunch_button.style.backgroundColor = "#fff";
      lunch_button.style.letterSpacing = ".2rem";
      lunch_button.style.border = "1px solid black";
...
function showSelectedHallName() {
  document
    .getElementById("myDropdownMenu")
    .addEventListener("click", function (event) {
      meal_name = "Lunch";
      hall_name = event.target.textContent;
      document.getElementById(
        "showSelectedHallName"
      ).innerHTML = `<div class="row py-3 m-0 third-row">
    <div class="col">
...
function addItemButtonClicked() {
  document
    .getElementById("add-element-container")
    .addEventListener("click", function (event) {
...
function closeAddItemPopupClicked() {
  document
    .getElementById("close-add-item-popup")
    .addEventListener("click", function (event) {
